...
# restruture the output or like system response
...
lbx[3*(N+1):3*(N+1)+2*N:2] = pwm_r_min                  # v lower bound for all V
lbx[3*(N+1)+1:3*(N+1)+2*N:2] = pwm_r_min                  # v lower bound for all V

ubx[3*(N+1):3*(N+1)+2*N:2] = pwm_r_max                  # v lower bound for all V
ubx[3*(N+1)+1:3*(N+1)+2*N:2] = pwm_l_max                  # v lower bound for all V
